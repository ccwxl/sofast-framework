...
public class CommonResult<T> implements Serializable {
    ...
    public CommonResult(String code, boolean success, String message, T data) {
        this.code = code;
    ...
    public static <T> CommonResult<T> ok() {
        return new CommonResult<>(SUCCESS_CODE, true, SUCCESS, null);
    }

    public static <T> CommonResult<T> ok(T data) {
        return new CommonResult<>(SUCCESS_CODE, true, SUCCESS, data);
    }

    public static <T> CommonResult<T> ok(String msg, T data) {
        return new CommonResult<>(SUCCESS_CODE, true, msg, data);
    }

    public static <T> CommonResult<T> ok(String code, String msg, T data) {
        return new CommonResult<>(code, true, msg, data);
    }

    public static <T> CommonResult<T> fail(String msg) {
        return new CommonResult<>(FAIL_CODE, false, FAIL, null);
    }

    public static <T> CommonResult<T> fail(String msg, T data) {
        return new CommonResult<>(FAIL_CODE, false, FAIL, data);
    }

    public static <T> CommonResult<T> fail(String code, String msg, T data) {
        return new CommonResult<>(code, false, msg, data);
    }
    ...
    public static <T> CommonResult<T> fail(ErrorCode errorCode, T data) {
        return new CommonResult<>(errorCode.getCode(), false, errorCode.getMessage(), data);
    }
}
