package cc.sofast.framework.starter.redis.redisson.starter;
...
public class RedissonAutoConfiguration {
    ...
    public RedissonClient redisson() throws IOException {
        ...
        if (getSingleServerConfig != null) {
            getSingleServerConfig.setAccessible(true);
            Object singleServerConfig = ReflectionUtils.invokeMethod(getSingleServerConfig, config);
            if (singleServerConfig instanceof SingleServerConfig sConfig) {
                sConfig.setConnectionMinimumIdleSize(1);
            }
        }
